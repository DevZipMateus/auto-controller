...
const NavBar = () => {
  ...
  return (
    <header className={cn(
      "fixed top-0 left-0 right-0 z-[99999] transition-all duration-300 ease-in-out will-change-transform",
      "!position-fixed transform-none contain-layout",
      scrolled 
        ? "py-1 sm:py-2 md:py-3 bg-white shadow-lg" 
        : "py-2 sm:py-3 md:py-4 bg-white/90"
    )}>
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="p-4 sm:p-6 border-t border-blue-100 mt-auto">
                <div className="text-blue-700 text-xs sm:text-sm text-center">
                  © 2024 Auto Controller System - Todos os direitos reservados
                </div>
              </div>
            </div>
          </SheetContent>
