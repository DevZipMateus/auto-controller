...
const Hero = () => {
  ...
  return (
    <section 
      id="home" 
      className="relative min-h-screen flex items-center justify-center pt-20 sm:pt-24 md:pt-28 lg:pt-32 overflow-hidden"
      style={{
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 text-center relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 
            ...
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold mb-4 sm:mb-6 opacity-0 leading-tight tracking-tight"
            style={{ 
          ...
          <p 
            ...
            className="text-white text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl max-w-5xl mx-auto mb-6 sm:mb-8 font-medium opacity-0 leading-relaxed tracking-wide px-2 sm:px-4"
            style={{ 
          ...
          <p 
            ...
            className="text-blue-100 text-sm sm:text-base lg:text-lg max-w-4xl mx-auto mb-6 sm:mb-8 lg:mb-12 opacity-0 leading-relaxed px-2 sm:px-4"
            style={{ 
          ...
          <div 
            ...
            className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8 lg:mb-12 opacity-0"
          ...
          <div 
            ...
            className="flex flex-col sm:flex-row lg:flex-row justify-center gap-3 sm:gap-4 lg:gap-6 opacity-0 px-4 sm:px-0"
          ...
          >
            <a 
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-4 sm:px-6 lg:px-8 py-3 sm:py-4 lg:py-5 rounded-lg sm:rounded-xl font-bold text-sm sm:text-base lg:text-lg transition-all duration-300 transform hover:scale-105 shadow-2xl border border-blue-500 hover:border-blue-400 tracking-wide"
            >
              SOLICITAR ORÇAMENTO
            </a>
            <button 
          ...
          <div 
            ...
            className="mt-8 sm:mt-12 lg:mt-16 xl:mt-20 opacity-0"
