...
const Hero = () => {
  ...
  return <section id="home" className="relative min-h-screen flex items-center justify-center pt-20 sm:pt-24 md:pt-28 lg:pt-32 overflow-hidden" style={{
    ...
    backgroundAttachment: 'fixed'
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 text-center relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div ref={el => elementsRef.current[0] = el} className="inline-flex items-center space-x-2 bg-white/95 backdrop-blur-sm rounded-full px-4 sm:px-6 py-2 sm:py-3 mb-6 sm:mb-8 opacity-0 shadow-lg">
          ...
          {/* Título principal */}
          <h1 ref={el => elementsRef.current[1] = el} className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold mb-4 sm:mb-6 opacity-0 leading-tight tracking-tight" style={{
          ...
          {/* Slogan */}
          <p ref={el => elementsRef.current[2] = el} className="text-white text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl max-w-5xl mx-auto mb-6 sm:mb-8 font-medium opacity-0 leading-relaxed tracking-wide px-2 sm:px-4" style={{
          ...
          <p ref={el => elementsRef.current[3] = el} className="text-blue-100 text-sm sm:text-base lg:text-lg max-w-4xl mx-auto mb-6 sm:mb-8 lg:mb-12 opacity-0 leading-relaxed px-2 sm:px-4" style={{
          ...
          <div ref={el => elementsRef.current[4] = el} className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8 lg:mb-12 opacity-0" style={{
          animationDelay: '800ms'
        }}>
            <div className="bg-white/20 backdrop-blur-md rounded-lg sm:rounded-xl px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-6 border border-white/30">
              <div className="flex items-center justify-center mb-2">
                <Satellite className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-300 mr-2" />
            ...
            <div className="bg-white/20 backdrop-blur-md rounded-lg sm:rounded-xl px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-6 border border-white/30">
              <div className="flex items-center justify-center mb-2">
                <MapPin className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-300 mr-2" />
                <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">Nacional</div>
              </div>
              <div className="text-xs sm:text-sm text-blue-100 font-medium tracking-wide">Cobertura</div>
            </div>
            <div className="bg-white/20 backdrop-blur-md rounded-lg sm:rounded-xl px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-6 border border-white/30">
              <div className="flex items-center justify-center mb-2">
                {[...Array(5)].map((_, i) => <Star key={i} className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-300 fill-current" />)}
              </div>
          ...
          <div ref={el => elementsRef.current[5] = el} className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8 lg:mb-12 opacity-0" style={{
          animationDelay: '1000ms'
        }}>
            <div className="flex items-center space-x-2 sm:space-x-3 bg-black/30 backdrop-blur-md rounded-full px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 border border-white/20">
          ...
          {/* Confiança adicional */}
          <div ref={el => elementsRef.current[7] = el} className="mt-8 sm:mt-12 lg:mt-16 xl:mt-20 opacity-0" style={{
          animationDelay: '1400ms'
        }}>
            <p className="text-blue-100 text-sm sm:text-base lg:text-lg mb-3 sm:mb-4 lg:mb-6 font-medium tracking-wide">
              Atuação em todo território Nacional e América Latina
            </p>
            <div className="flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-4 lg:space-x-8 text-blue-200 text-xs sm:text-sm font-medium tracking-wide">
      ...
      <button onClick={scrollToAbout} className="absolute bottom-4 sm:bottom-6 lg:bottom-8 left-1/2 -translate-x-1/2 text-white/80 hover:text-white transition-colors duration-300 animate-float" aria-label="Rolar para baixo">
